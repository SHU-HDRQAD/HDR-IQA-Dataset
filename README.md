...
To run the demo, please download the pre-trained model at [Baidu cloud](https://pan.baidu.com/s/1zkz_2iQz1PXWTpFrM2xeaA), put it in 'pretrained' folder, then run:
```python
python demo.py
```
